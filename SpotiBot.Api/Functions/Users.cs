...
namespace SpotiBot
{
    public class Users
    {
        ...
        public Users(IUserRepository userRepository, Api.ApiModels.IMapper mapper, IOptions<Api.Library.Options.SentryOptions> sentryOptions, IOptions<TestOptions> testOptions)
        {
