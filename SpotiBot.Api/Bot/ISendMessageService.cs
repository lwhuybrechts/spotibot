...
namespace SpotiBot.Api.Bot
{
    ...
    {
        Task<int> SendTextMessage(long chatId, string text, ParseMode parseMode = ParseMode.Markdown, bool disableWebPagePreview = true, int replyToMessageId = 0, ReplyMarkup replyMarkup = null);
